defmodule LittlestLibraryWeb.EnsureRolePlug do
  @moduledoc """
  ...
  ## Example
      ...
      plug LittlestLibraryWeb.EnsureRolePlug, [:user, :admin]

      plug LittlestLibraryWeb.EnsureRolePlug, :admin

      plug LittlestLibraryWeb.EnsureRolePlug, ~w(user admin)a
  """
